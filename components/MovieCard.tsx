                    ...
                    <img 
                      ...
                      <div className='z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full 
                        ...
                        >
                            ...
                            <p className='text-green-400 font-semibold mt-4 txt-rtl'>
                                جدید <span className='text-white'>2023</span>
                            </p>

                            <div className='flex flex-row mt-4 gap-2 items-center txt-rtl'>
                                <p className='text-white tetxt-[10px] lg:text-sm'>
                                    {data.duration}
                                </p>
                            </div>
